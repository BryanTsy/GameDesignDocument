...
namespace FlappyBird.Entities
{
    class Paratroopa : Entity
    {
        ...
        public Paratroopa(Type type, float speedModifier)
            : base(type)
        {
            this.Texture = Statics.GAME_CONTENT.Load<Texture2D>("Textures\\Entity\\flappy_paratroopa");
            ...
            Texture2D animated_Texture = Statics.GAME_CONTENT.Load<Texture2D>("Textures\\Entity\\flappy_paratroopa_animated");
