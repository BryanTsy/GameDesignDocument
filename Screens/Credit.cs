...

{
    class Credit : Screen
    {
          ...
          public override void LoadContent()
        {
            ...
            _backButton = new Rectangle((int)Statics.MANAGER_UI.TextureVectors["Credit\\Back"].X, (int)Statics.MANAGER_UI.TextureVectors["Credit\\Back"].Y, Statics.MANAGER_TEXTURES.Textures["UI\\Button"].Width, Statics.MANAGER_TEXTURES.Textures["UI\\Button"].Height);
            base.LoadContent();
        }
